        ...
        return Component.extend({
            defaults: {
                ...
                taxvat: (window.checkoutConfig &&
                    ...
                    window.checkoutConfig.payment.vindi_vp_cardbankslippix &&
                    window.checkoutConfig.payment.vindi_vp_cardbankslippix.customer_taxvat
                ) ? window.checkoutConfig.payment.vindi_vp_cardbankslippix.customer_taxvat.replace(/[^0-9]/g, "") : "",
                creditCardOwner: '',
            ...
            initObservable: function () {
                ...
                $(document).on('change', '#bankslippix_bankslip_amount', function() {
                    ...
                    if (bankslipAmount > grandTotal) {
                        self.showBankslipError(true);
                        self.bankslipErrorMessage($t('O valor excede o valor total do pedido.'));
                        $(this).addClass('error');
                        self.isFormValid(false);
                        return;
                    }
            ...
            getGrandTotal: function() {
                ...
                if (window.checkoutConfig &&
                    window.checkoutConfig.payment &&
                    window.checkoutConfig.payment.vindi_vp_cardbankslippix &&
                    window.checkoutConfig.payment.vindi_vp_cardbankslippix.grand_total) {
                    grandTotal = parseFloat(window.checkoutConfig.payment.vindi_vp_cardbankslippix.grand_total);
                }
                return grandTotal;
            },
            ...
            getPaymentProfiles: function () {
                ...
                var savedCards = window.checkoutConfig &&
                    window.checkoutConfig.payment &&
                    window.checkoutConfig.payment.vindi_vp_cardbankslippix &&
                    window.checkoutConfig.payment.vindi_vp_cardbankslippix.saved_cards;
